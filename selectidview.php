...
<body>
	<a href="selectid.php" class="btn btn-primary" role="button"><font size="5">回前頁</font></a>
	<hr>
	<?php
	//墓基資料顯示
		...
		if($base_id != null){
			...
			if($row != null){
				...
				<table class="table table-hover">
					<tr><td><font size="4">墓籍編號：</font></td><td><font size="4"><?php echo $row['roll_id'];?></font></td>
					<td><font size="4">墓基編號：</font></td><td><font size="4"><?php echo $newbase;?></font></td></tr>
