	    ...
	    if($year != null){
	    	...
	    	if($row != null){
	    		...
	    		<div style="text-align:left;width:100%;height:100%;margin:0 auto;">   
	    			<div style="text-align:center;width:350px;height:20%;margin:0 auto;">
	    				<h1><?php echo $row['year'];?>年消帳作業系統</h1><br>
	    			</div>
	    		</div>
	    	</div>
	    	<table class="table table-hover">
	    		<tr>
	    			...
	    			<th style="height:100%;width:28%;" align='left' valign="middle"><font size="5">墓基編號</font></th>
	    			<th style="height:100%;width:16%;" align='left' valign="middle"><font size="5">使用權人</font></th>
	    	...
	    	<form action="saleexe.php" method=POST>
	    		...
	    		<table class="table table-hover">
	    			<?php
	    			$sqlyear="select pay_index.*,price_index.price,roll_main.roll_id,roll_main.rightuser FROM pay_index inner join(price_index inner join roll_main on roll_main.base_id=price_index.base_id) on pay_index.base_id=roll_main.base_id and pay_index.year='".$year."'";
	    			...
	    			while($rowyear=mysql_fetch_array($resultyear)){
	    				...
	    				echo "<tr><td> ". $rowyear['year'] ."</td>";
	    				echo "<td> ". $rowyear['roll_id'] ."</td>";
	    				echo "<td> ". $newbaseryear ."</td>";
	    				echo "<td> ". $rowyear['rightuser'] ."</td>";
	    				echo "<td> ". $rowyear['price'] ."</td>";
